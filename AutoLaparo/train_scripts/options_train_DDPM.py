...
parser_phase.add_argument('--workers', type=int, default=3)
...
parser_phase.add_argument('--use_ema', action='store_true')
parser_phase.add_argument('--DDIM', action='store_true')
parser_phase.add_argument('--n_obs_steps', type=int, default=32)
parser_phase.add_argument('--n_action_steps', type=int, default=4)
parser_phase.add_argument('--infer_steps', type=int, default=100)
parser_phase.add_argument('--Obs', type=str, default='')
# training
...
parser_phase.add_argument('--CHE',action='store_true',help="Not carrying hidden in training")
parser_phase.add_argument('--CNN_output_loss',action='store_true',help="Use CNN-LSTM output for reg and cls supervisioin like BNPitfalls")
parser_phase.add_argument('--Phase_joint',action='store_true', help="jointly train for phase reg")