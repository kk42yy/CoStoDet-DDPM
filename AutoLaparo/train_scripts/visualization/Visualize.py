...
if __name__ == "__main__":
    visual_each(
        '/best_clip_length/frame_prop_figure/bestrefine__on256-phase.txt',
        '/gt_78_1-256/video78_1-phase.txt',
        '/best_clip_length/frame_prop_figure/bestrefine__on256-phase.png',
