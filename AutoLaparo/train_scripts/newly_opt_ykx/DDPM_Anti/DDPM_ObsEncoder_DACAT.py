...
class ObsEncoder_LSTM(nn.Module):
    def __init__(self,
        ...
        # only load Long Net
        long_net_pretrain_path = f'train_scripts/newly_opt_ykx/LongShortNet/long_net_{opts.backbone}.pth.tar'
    ...
    def forward(self, x):
        ...
        x = (self.cnn_short(x).reshape(1, -1, self.cnn_long.feature_size))
